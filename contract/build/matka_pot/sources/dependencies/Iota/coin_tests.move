...
fun assert_global(
    ...
    use iota::coin::{
        ...
        deny_list_v1_is_global_pause_enabled_current_epoch as is_global_pause_enabled_current_epoch,
    };
    assert!(
...
#[test]
fun deny_list_v1() {
    use iota::coin::{deny_list_v1_add as add, deny_list_v1_remove as remove};
